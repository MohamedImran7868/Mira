export function ConfirmEmailTemplate({ confirmationLink }) {
  return `
  <!DOCTYPE html>
    <html>
        <head>
        ...
        <body>
            <div class="header">
                <img src="https://www.mirahub.me/assets/Logo-ClVvsIpw.png" alt="Company Logo" class="logo">
            </div>
            
            <h2 style="color: #111;">Welcome to MIRA!</h2>
            ...
            <div style="text-align: center; margin: 25px 0;">
                <a href="${confirmationLink}" class="button" style="color: white;">Confirm Your Email</a>
            </div>
            
            <p>If you didn't request this account, please ignore this email or contact support if you have questions.</p>
            
            <p>Best regards,<br>The MIRA Team</p>
            
            <div class="footer">
                <p>© 2025 MIRA. All rights reserved.</p>
                <p>
                    <a href="https://www.mirahub.me/" style="color: #666; text-decoration: none;">Website</a>
                </p>
                <p>Multimedia University of Cyberjaya</p>
            </div>
        </body>
    </html>`;
}
